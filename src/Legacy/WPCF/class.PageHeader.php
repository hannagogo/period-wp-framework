...
class PageHeader extends ClassTemplate {
var $param = array();
...
public function add_menu() {
 ...
 $this->param('edit_page_suffix', 'edit_page_header');
 ...
 foreach( $post_types as $post_type_name ) {
  ...
  add_submenu_page(
   ...
   __('Edit Post Type Page Header', $custom_language_domain),
   __('Page Headers', $custom_language_domain),
   $capability,
...
public function edit_page_html() {
 ...
 echo createHTMLElement('h2', NULL, __('Edit Post Type Page Header', $custom_language_domain));
...
add_action('WPCF_Initialize', function(){ new PageHeader(); });